...
login.html  ──────────────→  dashboard.html
          ...
          ┌──────────────┬──────────────────────┬──────────────┬────────────────────┐
          ▼              ▼                      ▼              ▼                    ▼
  todo-list.html  prayer-times.html  utilities.html  electricity-tracker.html
          │              │                      │              │                    │
          └──────────────┴──────────────────────┴──────────────┴────────────────────┘
                                              │
                                       ← Back to Dashboard
...
- Left sidebar with vertical project tiles (Todo List, Prayer Times, Utilities, Electricity Tracker)
